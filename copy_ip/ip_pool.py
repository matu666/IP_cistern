...
from heade import get_user_agent
...
def get_ip():
    ...
    try:
        ...
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        print(
            "爬取失败,请在控制台输入 curl https://uu-proxy.com/api/free 查看是否返回代理池数据，如果返回代理池数据，请在 https://github.com/XgzK/IP_cistern 上提交issue")
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
...
def countdown(data):
    ...
    # 计算时间差
    cc = a2 - a1
    # 可以修改获取节点的时间间隔，默认是同步节点池刷新时间 如果想修改可以把+改成 / 表示除法
    cc = cc.seconds + 1  # 加1秒
    # print("等待时间", cc)
    time.sleep(cc)


def while_loop(path, line):
    """
    循环爬取IP
    :param path: 保存的文件路径
    :param line: 提交的行数
